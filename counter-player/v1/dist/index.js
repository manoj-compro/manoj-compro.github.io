...
var g = class extends (globalThis.HTMLElement ?? HTMLElementShimWithRealType) {
  ...
  static createProperty(t3, s4 = y) {
    if (s4.state && (s4.attribute = false), this._$Ei(), this.prototype.hasOwnProperty(t3) && ((s4 = Object.create(s4)).wrapped = true), this.elementProperties.set(t3, s4), !s4.noAccessor) {
      const i4 = /* @__PURE__ */ Symbol(), e4 = this.getPropertyDescriptor(t3, i4, s4);
...
var k = class {
  ...
  u(t3) {
    ...
    for (; void 0 !== r6; ) {
      if (o6 === r6.index) {
        let i5;
        2 === r6.type ? i5 = new R(h3, h3.nextSibling, this, t3) : 1 === r6.type ? i5 = new r6.ctor(h3, r6.name, r6.strings, this, t3) : 6 === r6.type && (i5 = new W(h3, this, t3)), this._$AV.push(i5), r6 = s4[++n5];
      }
...
var R = class _R {
  ...
  $(t3) {
    ...
    if (this._$AH?._$AD === e4) this._$AH.p(i4);
      ...
      const t4 = new k(e4, this), s5 = t4.u(this.options);
  ...
  k(t3) {
    ...
    const i4 = this._$AH;
    let s4, e4 = 0;
    for (const h3 of t3) e4 === i4.length ? i4.push(s4 = new _R(this.O(c3()), this.O(c3()), this, this.options)) : s4 = i4[e4], s4._$AI(h3), e4++;
...
var B = (t3, i4, s4) => {
  ...
  if (void 0 === h3) {
    ...
    e4._$litPart$ = h3 = new R(i4.insertBefore(c3(), t4), t4, void 0, s4 ?? {});
  }
...
var CounterPlayerElement = class extends i3 {
  constructor() {
    super(...arguments);
    this.playerId = "demo";
