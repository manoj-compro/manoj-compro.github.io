...
let moduleMap = {
  "./player": () => {
    dynamicLoadingCss([], false, "./player");
    return __federation_import("./__federation_expose_Player-BHewjcF9.js").then((module) => Object.keys(module).every((item) => exportSet.has(item)) ? () => module.default : () => module);
  }
};
const seen = {};
const dynamicLoadingCss = (cssFilePaths, dontAppendStylesToHead, exposeItemName) => {
  ...
  cssFilePaths.forEach((cssPath) => {
    ...
    if (dontAppendStylesToHead) {
      const key = "css__counterPlayerV1__" + exposeItemName;
