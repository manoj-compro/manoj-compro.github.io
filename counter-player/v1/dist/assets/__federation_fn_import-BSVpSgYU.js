...
const moduleMap = { "lit": { get: () => () => __federation_import(new URL("__federation_shared_lit-VFzmiMKn.js", import.meta.url).href), import: true, requiredVersion: "^3.3.1" }, "lit/decorators.js": { get: () => () => __federation_import(new URL("__federation_shared_lit/decorators.js-Cu0Ucm_C.js", import.meta.url).href), import: true, requiredVersion: "^3.3.1" }, "lodash": { get: () => () => __federation_import(new URL("__federation_shared_lodash-DIZFWshU.js", import.meta.url).href), import: true, requiredVersion: "3.10.1" } };
...
async function getSharedFromRuntime(name, shareScope) {
  ...
  if (globalThis?.__federation_shared__?.[shareScope]?.[name]) {
    ...
    if (hasRequiredVersion) {
      const versionKey = Object.keys(versionObj).find(
...
//# sourceMappingURL=__federation_fn_import-BSVpSgYU.js.map
